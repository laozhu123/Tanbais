...
public class StorageUtil {
    ...
    public static final long MIN_CAPACITY = 20 * M;
    public static final long LOW_CAPACITY = 100 * M;
    ...
    public static String getAppWritePath(String folderName, boolean isToast, Context context) {
        if (TextUtils.isEmpty(folderName))
            return null;
        ContextUtil contextUtil = new ContextUtil(context);
        String folderPath = contextUtil.getAppDir() + folderName;
    ...
    public  String getWriteSystemCameraPath(String fileName, boolean isToast) {
        String result = null;
